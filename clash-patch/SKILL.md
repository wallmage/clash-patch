---
name: clash-patch
description: Use when an agent needs to diagnose slow, intermittent, unavailable, misrouted, or leaking network behavior; safely update all Clash subscriptions; configure ClashX Meta or Clash Verge Rev for browsing, overseas AI, Claude, or Claude Code; or interpret voice-dictated “cloud” as Claude in a proxy or AI context.
---
